ocaml program that takes as input a directory containing EDGAR daily master files and prints the disk-space used by the files listed in these master files.
